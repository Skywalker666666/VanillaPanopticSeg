...
class SemanticSegmentation(Predict):
    ...
    def __init__(self, model_path: str = '/home/zhiliu/Documents/Weapons/gluon-cv/scripts/segmentation/runs/coco/psp/default/checkpoint.params',
    ...
    def classes(self) -> list:
        """Category coco index"""
        return [0, 5, 2, 16, 9, 44, 6, 3, 17, 62, 21, 67, 18, 19, 4,
                1, 64, 20, 63, 7, 72]
    ...
    def _load_model(self) -> PSPNet:
        ...
        """
        model = PSPNet(nclass=21, backbone='resnet50', pretrained_base=False, ctx=self.ctx,aux=True)
...
if __name__ == "__main__":
    ...
    predictor.predict()
    predictor.save_predictions(destination_dir='../../data/predictions', filename='predictions_test_ins_semantic.json')
